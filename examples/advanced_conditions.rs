...
fn demo_multi_way_branching() {
    ...
    let branch_0_step1 = taskflow
        .emplace(|| {
            println!("   [Branch 0 Step 1] Processing low value");
        })
        .name("branch_0_step1");

    let branch_0_step2 = taskflow
        .emplace(|| {
    ...
    let branch_1_step1 = taskflow
        .emplace(|| {
            println!("   [Branch 1 Step 1] Processing medium value");
        })
        .name("branch_1_step1");

    let branch_1_step2 = taskflow
        .emplace(|| {
    ...
    let branch_2_step1 = taskflow
        .emplace(|| {
            println!("   [Branch 2 Step 1] Processing high value");
        })
        .name("branch_2_step1");

    let branch_2_step2 = taskflow
        .emplace(|| {
