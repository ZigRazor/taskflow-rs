use taskflow_rs::{parallel_exclusive_scan, parallel_inclusive_scan, Executor, Taskflow};
...
fn demo_scan_operations() {
    ...
    // Maximum scan
    {
        ...
        let (_tasks, result) =
            parallel_inclusive_scan(&mut taskflow, data, 2, |a, b| a.max(b), i32::MIN);
